    ...
    <div className="animate-fade-in w-full text-center">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        ...
        >
          ...
          <span className="relative z-10 block text-xs font-bold leading-tight">
            Orang Tua
          </span>
          <span className="relative z-10 mt-0.5 block text-[10px] font-medium text-white/50 leading-tight">
            Masuk dengan NISN
          </span>
        </button>
